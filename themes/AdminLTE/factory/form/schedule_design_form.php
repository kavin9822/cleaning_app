			...
			<input id="ycs_ID" name="ycs_ID" value="<?php if($ycs_ID){echo $ycs_ID;}?>"  type="hidden">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
			           ...
			           <div class="col-sm-9">
					        <input class="form-control" id="ScheduleDate" onmouseover="ycsdate(this.id)" onkeypress="return onlyNumbernodecimal(event);" name="ScheduleDate" value="<?php if (isset($FmData[0]['ScheduleDate'])){echo date('d-m-Y',strtotime($FmData[0]['ScheduleDate']));} ?>"   placeholder="DD-MM-YYYY" data-date-format="DD-MM-YYYY"  type="text" tabindex="7" required>
			          </div>
		          </div>
                    ...
                    <div class="col-sm-9">
                        ...
                        <?php if($mode == 'edit' || $mode == 'view'){ ?>
                                    ...
                                    <?php  $i=0; foreach ($FmDataattachment as $datavalue):  ?>
                                            ...
                                            onclick="removeuploadedfile('<?php echo ($FmDataattachment[$i]['ID']); ?>','schedule_attachments');$(imglist_<?php echo $i?>).remove();return false;">Remove
                                            </a>
                                                 <?php } else if($mode == 'view'){?>
                                            <a href="#" class="mb-3 remove_cls removeFile<?php echo $i;?>" id="imglist_<?php echo $i;?>"
                                            onclick="removeuploadedfile('<?php echo ($FmDataattachment[$i]['ID']); ?>','schedule_attachments');$(imglist_<?php echo $i?>).remove();return false;">
                                            </a>
                                                 <?php }?>  
                                            <span>
                                            </span>&nbsp;</a>
