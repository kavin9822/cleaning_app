    ...
    ?>
		...
		<div class="row" style="margin:20px">
			<input id="ycs_ID" name="ycs_ID" value="<?php if($ycs_ID){echo $ycs_ID;}?>"  type="hidden">
			   ...
			   <div class="col-lg-6">
               <div class="form-group">
                       <label  class="col-sm-3 control-label">Service provider Type</label>
			           <div class="col-sm-9">
			              <select class="form-control js-example-basic-single" name="ServiceproviderType" id="ServiceproviderType" tabindex="2" onmouseover="ycssel()" required>
                              <option value="" disabled selected style="display:none;">Select</option>
                              <?php foreach ($serviceprovider_type_data as $k => $v): 
                              if ($v['ID'] == $FmData[0]['ServiceproviderType']) {
                              $isselected = 'selected="selected"';
                              }else{
                              $isselected = '';
                              }
